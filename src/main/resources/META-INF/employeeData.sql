...
insert into employee(name,age,email,department) values ('sindhu',20,'sindhu@gmail.com',1);
insert into employee(name,age,email,department) values ('thanh',20,'thanh@gmail.com',2);
